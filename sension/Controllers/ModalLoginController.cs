...
using sension.Context;
using sension.Infrastructure.Concrete;
using sension.ModalLogin;
using sension.ModalLogin.Abstract;
using sension.ModalLogin.Models;

namespace sension.Controllers
{
